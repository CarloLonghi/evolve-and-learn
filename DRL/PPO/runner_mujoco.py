...
class LocalRunner(Runner):
    ...
    def _make_mjcf(env_descr: Environment) -> str:
        ...
        for actor_index, posed_actor in enumerate(env_descr.actors):
            ...
            LocalRunner._set_joint_parameters(robot)
    ...
    @staticmethod
    def _set_joint_recursive_parameters(element):
        if element.tag == "body":
            for sub_element in element.body._elements:
                LocalRunner._set_joint_recursive_parameters(sub_element)
    ...
    @staticmethod
    def _set_joint_parameters(robot):
        for element in robot.worldbody.body._elements:
            LocalRunner._set_joint_recursive_parameters(element)